...
<body>       
    <div>
		<%
			...
			int gatherNumber = request.getParameter("gatherNumber").isEmpty() ? 1 : Integer.parseInt(request.getParameter("gatherNumber"));
			int sleepTime = request.getParameter("sleepTime").isEmpty() ? 1000 : Integer.parseInt(request.getParameter("sleepTime")) * 1000;
